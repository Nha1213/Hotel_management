const {getAllRoom, createRoom, deleteRoom, updateRoom, updateStatusRoom} = require("../controllers/Room.controller");
...
const roomRoute = (app) =>{
    ...
    app.put("/api/room/status/:id", validate_token(), updateStatusRoom);
}
